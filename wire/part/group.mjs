...
/**
 * @param {import('./ingress.mjs').PartWireAdapter} wire 底层适配器
 * @param {string} groupId 群 ID
 * @returns {import('./ingress.mjs').PartWireAdapter['on']} 注入 groupId 的 on 包装
 */
 ...
 * @param {string} groupId 群 ID
 * @param {import('./ingress.mjs').PartWireAdapter} wire Trystero 适配器
