...
import { createReassembler, DEFAULT_MAX_FRAME_CHUNK_BYTES, encodeFrames, randomFrameIdHex } from './frame.mjs'
...
export function createLinkPipe(options) {
	...
	const maxFrameBytes = Math.max(256, Number(options.maxFrameBytes) || DEFAULT_MAX_FRAME_CHUNK_BYTES)
