...
import { REP_MAX } from '../reputation/math.mjs'
import { pickTop } from '../trust_graph/engine.mjs'
import {
...
import { applyFollowedBlockSignalPure } from './social_reputation.mjs'
 ...
 * @param {number} reachHarm cleanReach 减 discReach
 ...
 * @typedef {{
 *   id: string,
 *   reputation: import('../node/reputation_store.mjs').ReputationFile,
 *   trustedPeers: string[],
 *   explorePeers: string[],
...
export function runSimulation(scenario, seed, tunables, attackGenome) {
	...
	for (let round = 0; round < rounds; round++) {
		...
		for (const obs of observers) {
			...
			/**
			 * @param {string} id 64 位十六进制 nodeHash
