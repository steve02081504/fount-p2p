...
test('randomAttackGenome and mutate are deterministic with seed', () => {
...
test('resolveAttackParams merges global and per-attack overrides', () => {
...
test('attack hall of fame keeps top fitness', () => {
