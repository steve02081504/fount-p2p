...
test('quantize removes float tails', () => {
...
test('quantize default preserves fractional values', () => {
	assertEquals(quantize(0.22), 0.22)
	assertEquals(quantize(-0.4), -0.4)
	assertEquals(quantize(0.62), 0.62)
})

test('sampleParam stays inside each semantic domain', () => {
...
test('randomCandidate archive quorum ordering', () => {
