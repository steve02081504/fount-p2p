...
test('observerHasLocalReplica requires honest majority and anchor or archive-heavy', () => {
...
test('integrityDefendsAgainst archive_forger with verified forgery', () => {
...
test('blendArchiveQuorumAccuracy weights replica observers', () => {
...
test('replicaObserverFraction counts observers with replicas', () => {
	const scenario = {
		honestCount: 10,
		groupSize: 12,
		behaviorDist: { archiveSubmitRate: { mean: 0.2 } },
