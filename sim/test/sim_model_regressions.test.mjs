...
test('reachCollapse does not shrink with observer count', () => {
...
test('newcomers excluded from falsePositiveRate', () => {
	const tunables = loadDefaultTunables()
...
test('verifiedForgery is per-observer not global', () => {
...
test('takeRoomSlot enforces maxNonTrusted cap', () => {
...
test('eclipse cluster mates fill explore together', () => {
	const state = createDiscoveryState()
...
test('transport trusted peers reserve slots per observer', () => {
...
test('buildWorld wires per-observer transport with trusted anchors', () => {
