...
test('sampleBehavior produces 9-dim vector in [0,1]', () => {
...
test('isQuietHonestBehavior detects low-post high-like users', () => {
...
test('quiet_honest scenario preserves silent users', () => {
