...
export const TUNABLES_PATHS = Object.freeze({
	...
	mailbox: new URL('../mailbox/tunables.json', import.meta.url).pathname.replace(/\\/g, '/'),
	archive: new URL('../dag/tunables.json', import.meta.url).pathname.replace(/\\/g, '/'),
	admission: new URL('../governance/tunables.json', import.meta.url).pathname.replace(/\\/g, '/'),
})
