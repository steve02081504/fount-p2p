...
/**
 * 将 {@link PARAM_SPACE} 中各 tunables 键规整回语义域。
 * @param {import('./tunables_bundle.mjs').TunablesBundle} bundle 待规整的参数包
 * @returns {import('./tunables_bundle.mjs').TunablesBundle} 语义域规整后的参数包
 */
...
/**
 * 关系规则：严格仲裁人数不得低于基础收集仲裁人数（否则语义自相矛盾）。
 * @param {import('./tunables_bundle.mjs').TunablesBundle} bundle 待修正的参数包（就地修改）
 * @returns {void}
 */
...
/**
 * 对参数包施加结构性关系规则（如 archive quorum 一致性）。
 * @param {import('./tunables_bundle.mjs').TunablesBundle} bundle 待归一的参数包
 * @returns {import('./tunables_bundle.mjs').TunablesBundle} 规则归一后的参数包
 */
...
/**
 * 在语义域内随机采样一组 tunables 候选。
 * @param {number} seed 随机种子
 * @returns {import('./tunables_bundle.mjs').TunablesBundle} 随机候选参数包
 */
