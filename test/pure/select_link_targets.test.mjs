...
import { resolveFederationPoolLimits, selectLinkTargetsFromMembers } from '../../transport/peer_pool.mjs'
...
test('selectLinkTargetsFromMembers: top-K trusted + explore, filters self/blocked/quarantine', () => {
...
test('selectLinkTargetsFromMembers: anchors always connected even beyond trusted budget', () => {
...
test('selectLinkTargetsFromMembers: explore fills remaining members when slots ample', () => {
...
test('selectLinkTargetsFromMembers: empty members yields nothing', () => {
