...
test('computeRecidivismMultiplier escalates with streak', () => {
...
test('repeat penalties escalate without time window reset', () => {
...
test('positive contribution redeems offense streak', () => {
	const data = ensureReputationShape({ byNodeHash: {}, wantUnknownHits: [], relayBumpSeen: [] })
...
test('pruneReputationFile does not clear offense streak by time', () => {
...
test('badInviteeCount increments and redeems via contribution', () => {
	const data = ensureReputationShape({ byNodeHash: {}, wantUnknownHits: [], relayBumpSeen: [] })
