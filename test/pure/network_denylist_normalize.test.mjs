...
import { normalizeDenylist } from '../../node/denylist.mjs'
import { normalizeNetwork, isPeerPoolKeyBlocked } from '../../node/network.mjs'
import { assertEquals } from '../helpers/assert.mjs'
import { placeholderEntityHash } from '../helpers/fixtures.mjs'
...
test('normalizeDenylist entity scope requires 128 hex', () => {
...
test('normalizeDenylist drops entity scope groupId', () => {
	const list = normalizeDenylist({
...
test('isPeerPoolKeyBlocked matches deny scopes separately', () => {
	const view = {
		trustedPeers: [],
		explorePeers: [],
		blockedPeers: [NODE_A],
