...
import { ensureReputationShape, isQuarantinedPure, observeBehaviorSamplePure } from '../../reputation/engine.mjs'
import reputationTunables from '../../reputation/tunables.json' with { type: 'json' }
import { assertEquals } from '../helpers/assert.mjs'

test('observeBehaviorSamplePure triggers quarantine after baseline drift', () => {
